...
$(MEM_0)_START := 0x11401000
$(MEM_0)_END := 0x114017ff
...
# Memory: flash_generic_tristate_controller
MEM_1 := flash_generic_tristate_controller
$(MEM_1)_NAME := flash_generic_tristate_controller
...
$(MEM_1)_HIERARCHICAL_PATH := flash_generic_tristate_controller
$(MEM_1)_WIDTH := 8
...
.PHONY: flash_generic_tristate_controller
flash_generic_tristate_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym $(MEM_1).flash
