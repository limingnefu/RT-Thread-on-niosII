...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Qsys_vhd.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11402080
SOPC_SYSID_FLAG += --sidp=0x11402080
ELF_PATCH_FLAG  += --sidp 0x11402080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1631501563
SOPC_SYSID_FLAG += --timestamp=1631501563
ELF_PATCH_FLAG  += --timestamp 1631501563
